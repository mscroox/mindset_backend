...
function generateMindsetPrompt(responses) {
  ...
  - If business mindset responses is irrelatable or anything that is not understandable do not generate complete report just add in the report that unable to generate Report as We are not able to understand your answers.
  `;
}
